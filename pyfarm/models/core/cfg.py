...
TABLE_USERS_USER = "%s_user" % TABLE_USERS
TABLE_USERS_ROLE = "%s_role" % TABLE_USERS
TABLE_USERS_USER_ROLES = "%s_user_roles" % TABLE_USERS
TABLES = (TABLE_AGENT_TAGS, TABLE_AGENT_SOFTWARE, TABLE_AGENT_SOFTWARE,
          TABLE_AGENT, TABLE_JOB_TYPE, TABLE_USERS_USER, TABLE_USERS_ROLE,
          TABLE_USERS_USER_ROLES, TABLE_TASK, TABLE_TASK_DEPENDENCIES,
          TABLE_JOB_DEPENDENCIES, TABLE_JOB_TAGS, TABLE_JOB_SOFTWARE, TABLE_JOB)
