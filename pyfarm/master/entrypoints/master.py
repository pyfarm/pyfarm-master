...
def load_api(app_instance, api_instance):
    ...
    from pyfarm.master.api.software import schema as software_schema
...
def load_admin(admin_instance):
    ...
    from pyfarm.master.admin.agents import AgentView, AgentTagView
    from pyfarm.master.admin.work import (
        JobView, JobTagView, TaskView)
